...
function useSidebar() {
  ...
  if (!context) {
    ...
    throw new Notification('useSidebar must be used within a SidebarProvider.');
  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            'bg-transparent relative h-svh w-[--sidebar-width] transition-[width] duration-300 ease-linear',
