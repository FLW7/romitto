  ...
  return (
    <Dialog open={isModalOpen} onOpenChange={onClose}>
      <DialogContent
        ...
        className={`z-[52] mx-auto max-h-[650px] w-[1080px] max-w-full overflow-hidden bg-white px-[70px] pb-[50px] pt-[50px] text-black max-[1200px]:w-[768px] min-[1200px]:pl-[70px] min-[1200px]:pr-[38px]`}
      >
